...
<template>
  <div class="w-full h-full backdrop-blur-md flex place-content-center">
    ...
    >
      ...
      <form
        @submit.prevent="submitAuthenticationForm"
      ...
      >
        ...
        <div class="flex flex-row items-center justify-between mb-[16px]">
          ...
          <router-link
            to=""
            class="ml-auto text-[12px] text-secondary-100 hover:text-secondary-80"
            >Forgot Password?
          </router-link>
        </div>
        ...
        <button
          type="submit"
          class="px-[38px] py-[8px] self-center rounded-[5px] bg-primary-100 hover:bg-primary-80 mb-[16px]"
