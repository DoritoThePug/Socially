<template>
  <div class="w-full">
    <div class="flex bg-white rounded-[25px] dropShadow overflow-x-hidden">
      <div class="w-[10%] pl-[16px] py-[16px]">
        <div
          class="h-[42px] w-[42px] bg-gray-600 rounded-full inline-block"
        ></div>
      </div>

      <div
        class="flex flex-col w-[90%] pt-[24px] pb-[16px] pb-[16px] pr-[24px]"
      >
        <textarea
          class="resize-none overflow-hidden focus: outline-none w-full min-h-[16px]"
          placeholder="What's poppin'?"
          ref="postInputTextArea"
          v-model="postContent"
        ...
        <div class="flex justify-between mt-[16px]">
          <div class="self-center inline-block">
            ...
            <button>
              <i
                class="fa-solid fa-square-poll-vertical text-[24px] mr-[16px]"
              ></i>
            </button>
            <button>
          ...
          <button
            class="bg-primary-100 h-[39px] w-[140px] rounded-[5px] inline-block"
            @click="submitPost"
          >
